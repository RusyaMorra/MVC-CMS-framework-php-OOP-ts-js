...
<html lang="ru">
  ...
  <body class="App">
    <div class="background-spot" style="background-image: url('<? echo APP_USER_PATH; ?>assets/images/main-img/background/background-main.jpg');">
      <div class="overflow-for-context">
        <header class="header container-fluid mx-auto d-flex flex-nowrap">
          <div class="logo col-2 h-100 d-flex justify-content-center align-items-center"><img src="<? echo APP_USER_PATH; ?>assets/images/main-img/logo/logo.png" alt></div>
          ...
          <div class="additional-elements col-2 h-100 d-flex justify-content-center align-items-center"><a class="button-offer" href>Оставить заявку</a></div>
        </header>
